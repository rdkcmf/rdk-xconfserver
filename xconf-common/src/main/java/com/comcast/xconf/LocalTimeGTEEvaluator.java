...
public class LocalTimeGTEEvaluator extends BaseEvaluator {
    ...
    public LocalTimeGTEEvaluator(){
        super(FreeArgType.forName("LOCAL_TIME"), StandardOperation.GTE, String.class);
    }
