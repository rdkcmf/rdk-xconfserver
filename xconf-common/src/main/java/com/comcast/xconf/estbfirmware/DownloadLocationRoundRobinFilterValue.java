...
public class DownloadLocationRoundRobinFilterValue extends SingletonFilterValue implements Applicationable {
    ...
    private List<Model> rogueModels = new ArrayList<Model>();
    ...
    public List<Model> getRogueModels() {
        if (rogueModels == null) {
            rogueModels = new ArrayList<Model>();
        }
        return rogueModels;
    }

    public void setRogueModels(List<Model> rogueModels) {
        this.rogueModels = rogueModels;
    }
    ...
    public boolean isNeverUseHttp() {
        return neverUseHttp;
    }

    public void setNeverUseHttp(boolean neverUseHttp) {
        this.neverUseHttp = neverUseHttp;
    }
    ...
    public void setFirmwareVersions(String firmwareVersions) {
    ...
    public boolean equals(Object o) {
        ...
        if (neverUseHttp != that.neverUseHttp) return false;
        ...
        if (ipv6locations != null ? !ipv6locations.equals(that.ipv6locations) : that.ipv6locations != null)
            return false;
        if (rogueModels != null ? !rogueModels.equals(that.rogueModels) : that.rogueModels != null) return false;
        if (httpLocation != null ? !httpLocation.equals(that.httpLocation) : that.httpLocation != null) return false;
        if (httpFullUrlLocation != null ? !httpFullUrlLocation.equals(that.httpFullUrlLocation) : that.httpFullUrlLocation != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (rogueModels != null ? rogueModels.hashCode() : 0);
        ...
        result = 31 * result + (neverUseHttp ? 1 : 0);
