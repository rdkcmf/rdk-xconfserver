...
@Configuration
public class DatastoreTestContext {

    @Bean
    ISimpleCachedDAO<String, SampleEntity> sampleEntitiesDao() {
        return DaoFactory.Simple.createCachedDAO(String.class, SampleEntity.class);
    }
