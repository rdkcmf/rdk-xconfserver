...
public class EnvModelPage extends PageObject {

    @FindBy(css = "input[title='description']")
    protected WebElementFacade descriptionInput;

    public EnvModelPage(WebDriver webDriver) {
        super(webDriver);
    }
