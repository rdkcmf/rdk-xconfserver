...
public class DownloadLocationFilterUtils {
    ...
    public static DownloadLocationRoundRobinFilterValue createDefaultRoundRobinFilter() throws Exception {
        ...
        result.setNeverUseHttp(true);
        List<String> firmwareVersions = Arrays.asList("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k");
        result.setFirmwareVersions(StringUtils.join(firmwareVersions, System.lineSeparator()));
