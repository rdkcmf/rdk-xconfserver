...
public class LogUploadSettingsControllerTest extends BaseControllerTest{
    ...
    public void getLogUploadSettings() throws Exception {
        ...
        mockMvc.perform(get("/dcm/logUploadSettings/" + logUploadSettings.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(logUploadSettings)));

        mockMvc.perform(get("/dcm/logUploadSettings/")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(logUploadSettings))));
    }
    ...
    public void getPage() throws Exception {
        ...
        mockMvc.perform(get("/dcm/logUploadSettings/page")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void getDeviceSettingsNames() throws Exception {
        ...
        mockMvc.perform(get("/dcm/logUploadSettings/names")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(logUploadSettings.getName()))));
    }
    ...
    public void saveLogUploadSettings() throws Exception {
        ...
        mockMvc.perform(post("/dcm/logUploadSettings")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(logUploadSettings)))
    ...
    public void saveLogUploadSettingsWithInvalidCronDayAndMonth() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/dcm/logUploadSettings")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(logUploadSettings)))
    ...
    public void deleteLogUploadSettings() throws Exception {
        ...
        mockMvc.perform(delete("/dcm/logUploadSettings/" + logUploadSettings.getId())
                .contentType(MediaType.APPLICATION_JSON))
    ...
    public void testGetLogUploadSettingsSize() throws Exception {
        ...
        mockMvc.perform(get("/dcm/logUploadSettings/size")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andExpect(content().json(CoreUtil.toJSON("1")));
    ...
    public void checkSorting() throws Exception {
        ...
        mockMvc.perform(get("/dcm/logUploadSettings/page")
                .param("pageSize", "10").param("pageNumber", "1"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(logUploadSettingsList)));
    }
    ...
    public void getFiltered() throws Exception {
        ...
        mockMvc.perform(post("/dcm/logUploadSettings/filtered")
                .param("pageNumber", "1")
                .param("pageSize", "10").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(searchContext)))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Collections.singletonList(logUploadSettings1))));
    }
