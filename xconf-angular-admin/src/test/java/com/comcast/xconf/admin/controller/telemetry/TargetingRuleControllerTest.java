...
public class TargetingRuleControllerTest extends BaseControllerTest {
    ...
    public void create() throws Exception {
        ...
        mockMvc.perform(post("/telemetry/rule").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(telemetryRule)))
                .andExpect(status().isCreated())
                .andExpect(content().json(CoreUtil.toJSON(telemetryRule)));
    }
    ...
    public void exportOne() throws Exception {
        ...
        performExportRequestAndVerifyResponse("/telemetry/rule/" + telemetryRule.getId(), result, ApplicationType.STB);
    }
    ...
    public void exportAll() throws Exception {
        ...
        performExportRequestAndVerifyResponse("/telemetry/rule", result, ApplicationType.STB);
    }
    ...
    public void createRuleNormalizeCondition() throws Exception {
        ...
        String actualResult = mockMvc.perform(post("/telemetry/rule")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(telemetryRule))).andReturn().getResponse().getContentAsString();
    ...
    public void creatingReturnsValidationException() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/telemetry/rule").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(telemetryRule)))
    ...
    public void update() throws Exception {
        ...
        mockMvc.perform(put("/telemetry/rule")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(telemetryRule)))
    ...
    public void updatingReturnsValidationException() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(put("/telemetry/rule")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(ruleToUpdate)))
                .andExpect(status().isBadRequest());
    ...
    public void updateRuleNormalizeCondition() throws Exception {
        ...
        String actualResult = mockMvc.perform(put("/telemetry/rule")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(telemetryRuleToUpdate))).andReturn().getResponse().getContentAsString();
    ...
    public void getAllTelemetryRules() throws Exception {
        ...
        mockMvc.perform(get("/telemetry/rule/" + telemetryRule.getId())
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(telemetryRule)));

        mockMvc.perform(get("/telemetry/rule")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(telemetryRule))));
    }
    ...
    public void getTelemetryRules() throws Exception {
        ...
        MockHttpServletResponse response = mockMvc.perform(post("/telemetry/rule/filtered")
                .contentType(MediaType.APPLICATION_JSON)
                .param("pageSize", "100")
    ...
    public void deleteTelemetryRule() throws Exception {
        ...
        mockMvc.perform(delete("/telemetry/rule/" + telemetryRule.getId())
                .contentType(MediaType.APPLICATION_JSON))
    ...
    public void checkSorting() throws Exception {
        ...
        mockMvc.perform(get("/telemetry/rule"))
                .andExpect(status().isOk())
                .andExpect(content().string(CoreUtil.toJSON(telemetryRules)));
    }
    ...
    public void searchFirmwareRuleByFreeAndFixedArg() throws Exception {
        ...
        mockMvc.perform(post("/telemetry/rule/filtered")
                .contentType(MediaType.APPLICATION_JSON)
                .param("pageSize", "1")
                .param("pageNumber", "1")
                .content(CoreUtil.toJSON(searchContext)))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(telemetryRule1))));
