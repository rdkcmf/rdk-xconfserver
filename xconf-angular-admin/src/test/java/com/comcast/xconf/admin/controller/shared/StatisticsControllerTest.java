...
public class StatisticsControllerTest extends BaseControllerTest {
    ...
    public void testStatistic() throws Exception {
        ...
        mockMvc.perform(get("/stats/").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());

        MockHttpServletResponse response = mockMvc.perform(get("/stats/cache/"+ "GenericXconfNamedList" + "/reload")
