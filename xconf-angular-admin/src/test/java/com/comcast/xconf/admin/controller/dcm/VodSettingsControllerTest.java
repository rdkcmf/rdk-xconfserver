...
public class VodSettingsControllerTest extends BaseControllerTest {
    ...
    public void getVodSettings() throws Exception {
        ...
        mockMvc.perform(get("/dcm/vodsettings/" + vodSettings.getId()))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(vodSettings)));

        mockMvc.perform(get("/dcm/vodsettings"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(vodSettings))));
    }
    ...
    public void save() throws Exception {
        ...
        mockMvc.perform(post("/dcm/vodsettings")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(vodSettings)))
    ...
    public void getPage() throws Exception {
        ...
        mockMvc.perform(get("/dcm/vodsettings/page")
                .contentType(MediaType.APPLICATION_JSON)
                .param("pageSize", "10")
                .param("pageNumber", "1"))
                .andExpect(status().isOk())
    ...
    public void deleteVodSettings() throws Exception {
        ...
        mockMvc.perform(delete("/dcm/vodsettings/" + vodSettings.getId()))
    ...
    public void getVodSettingsSize() throws Exception {
        ...
        mockMvc.perform(get("/dcm/vodsettings/size"))
                .andExpect(status().isOk())
    ...
    public void checkSorting() throws Exception {
        ...
        mockMvc.perform(get("/dcm/vodsettings/page")
                ...
                .param("pageNumber", "1"))
                .andExpect(status().isOk())
                .andExpect(content().string(CoreUtil.toJSON(vodSettingsList)));
    }
    ...
    public void getFiltered() throws Exception {
        ...
        mockMvc.perform(post("/dcm/vodsettings/filtered")
                .param("pageNumber", "1")
                .param("pageSize", "10").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(searchContext)))
                .andExpect(status().isOk()).andExpect(content().json(CoreUtil.toJSON(Collections.singletonList(vodSettings1))));
    }
