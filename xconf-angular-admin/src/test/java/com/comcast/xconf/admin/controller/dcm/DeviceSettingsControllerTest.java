...
public class DeviceSettingsControllerTest extends BaseControllerTest{
    ...
    public void testGet() throws Exception {
        ...
        mockMvc.perform(get("/dcm/deviceSettings/" + deviceSettings.getId()))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(deviceSettings)));
        mockMvc.perform(get("/dcm/deviceSettings/"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(deviceSettings))));
    }
    ...
    public void testGetPage() throws Exception {
        DeviceSettings deviceSettings = createDeviceSettings();
        deviceSettingsDAO.setOne(deviceSettings.getId(), deviceSettings);
        mockMvc.perform(get("/dcm/deviceSettings/page")
                .param("pageSize", "10")
                .param("pageNumber", "1")
    ...
    public void testSaveDeviceSettings() throws Exception {
        ...
        mockMvc.perform(post("/dcm/deviceSettings")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(deviceSettings)))
                .andExpect(content().json(CoreUtil.toJSON(deviceSettings)));
    }
    ...
    public void saveDeviceSettingsWithInvalidCronDayAndMonth() throws Exception {
        ...
        System.out.println(deviceSettings);
        ResultActions resultActions = mockMvc.perform(post("/dcm/deviceSettings")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(deviceSettings)))
    ...
    public void testGetDeviceSettingsNames() throws Exception {
        DeviceSettings deviceSettings = createDeviceSettings();
        deviceSettingsDAO.setOne(deviceSettings.getId(), deviceSettings);
        mockMvc.perform(get("/dcm/deviceSettings/names"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(deviceSettings.getName()))));
    }
    ...
    public void testDeleteDeviceSettings() throws Exception {
        DeviceSettings deviceSettings = createDeviceSettings();
        deviceSettingsDAO.setOne(deviceSettings.getId(), deviceSettings);
        mockMvc.perform(delete("/dcm/deviceSettings/" + deviceSettings.getId()))
    ...
    public void testGetDeviceSettingsSize() throws Exception {
        DeviceSettings deviceSettings = createDeviceSettings();
        deviceSettingsDAO.setOne(deviceSettings.getId(), deviceSettings);
        mockMvc.perform(get("/dcm/deviceSettings/size"))
                .andExpect(status().isOk())
    ...
    public void checkSorting() throws Exception {
        ...
        mockMvc.perform(get("/dcm/deviceSettings/page")
                ...
                .param("pageNumber", "1"))
                .andExpect(status().isOk())
                .andExpect(content().string(CoreUtil.toJSON(deviceSettingsList)));
    }
    ...
    public void getFiltered() throws Exception {
        ...
        mockMvc.perform(post("/dcm/deviceSettings/filtered")
                .param("pageNumber", "1")
                .param("pageSize", "10")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(context)))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Collections.singletonList(deviceSettings1))));
    }
