...
public class FirmwareRuleTemplateControllerTest extends BaseControllerTest {
    ...
    public void getFirmwareRuleTemplate() throws Exception {
        ...
        mockMvc.perform(get("/firmwareruletemplate/" + firmwareRuleTemplate.getId()))
                .andExpect(status().isOk()).andExpect(content().json(CoreUtil.toJSON(firmwareRuleTemplate)));
        mockMvc.perform(get("/firmwareruletemplate"))
                .andExpect(status().isOk()).andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(firmwareRuleTemplate))));
    }
    ...
    public void create() throws Exception {
        ...
        mockMvc.perform(post("/firmwareruletemplate")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(firmwareRuleTemplate)))
    ...
    public void update() throws Exception {
        ...
        firmwareConfigDAO.setOne(firmwareConfig.getId(), firmwareConfig);
        FirmwareRuleTemplate firmwareRuleTemplate = createFirmwareRuleTemplate();
        mockMvc.perform(post("/firmwareruletemplate").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(firmwareRuleTemplate)))
                .andExpect(status().isCreated());
        firmwareRuleTemplate.getRule().getCondition().getFreeArg().setName("changedName");

        mockMvc.perform(put("/firmwareruletemplate").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(firmwareRuleTemplate)))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(firmwareRuleTemplate)));
    }
    ...
    public void deleteFirmwareRuleTemplate() throws Exception {
        ...
        mockMvc.perform(delete("/firmwareruletemplate/" + firmwareRuleTemplate.getId()))
    ...
    public void importAlreadyExistingTemplatesWithOverwriteFalse() throws Exception {
        ...
        String actualResult = mockMvc.perform(post("/firmwareruletemplate/import").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(wrappedTemplates)))
    ...
    public void importManyTemplatesCheckThatPriorityWasSavedCorrectly() throws Exception {
        ...
        mockMvc.perform(post("/firmwareruletemplate/import").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(wrappedTemplates)))
                .andExpect(status().isOk()).andReturn().getResponse().getContentAsString();
    ...
    public void getAllFirmwareRuleTemplates() throws Exception {
        ...
        MockHttpServletResponse result = mockMvc.perform(
                post("/firmwareruletemplate/filtered")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void exportFirmwareRuleTemplate() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(get("/firmwareruletemplate/" + id).param("export", ""))
                .andExpect(status().isOk())
    ...
    public void exportFirmwareRuleTemplateNegative() throws Exception {
        ...
        final ResultActions resultActions = mockMvc.perform(get("/firmwareruletemplate/" + nonExistentId).param("export", ""));
    ...
    public void exportAllFirmwareRuleTemplates() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(get("/firmwareruletemplate/").param("export", ""))
                .andExpect(status().isOk()).andReturn().getResponse();
    ...
    public void exportAllFirmwareRuleTemplatesByType() throws Exception {
        ...
        final MockHttpServletResponse response = mockMvc.perform(get("/firmwareruletemplate/export/").param("type", "RULE_TEMPLATE"))
                .andExpect(status().isOk()).andReturn().getResponse();
    ...
    public void searchFirmwareRuleByFreeAndFixedArg() throws Exception {
        ...
        verifySearchResult("/firmwareruletemplate/filtered", searchContext, Lists.newArrayList(firmwareRuleTemplate, firmwareRuleTemplate1));
        ...
        verifySearchResult("/firmwareruletemplate/filtered", searchContext, new ArrayList<>());

        verifySearchResult("/firmwareruletemplate/filtered", new HashMap<SearchFields, String>(), Lists.newArrayList(firmwareRuleTemplate, firmwareRuleTemplate1));
    ...
    public void createTemplateWithoutConditions() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/firmwareruletemplate")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(firmwareRuleTemplate)))
    ...
    public void deleteTemplateWhichIsUsedByFirmwareRule() throws Exception {
        ...
        String errorMessage = mockMvc.perform(delete("/firmwareruletemplate/" + template.getId()))
    ...
    public void deleteTemplateWhichIsUsedByFirmwareRulesWithDifferentApplicationTypes() throws Exception {
        ...
        mockMvc.perform(delete("/firmwareruletemplate/" + template.getId()))
                .andExpect(status().isConflict())
                .andExpect(errorMessageMatcher("Template " + template.getId() + " is used by rules: " + Joiner.on(", ").join(firmwareRuleNames)));
    }

    private FirmwareRuleTemplate createAndSaveFirmwareTemplate(String id, ApplicableAction.Type type) throws ValidationException {
    ...
    private List<FirmwareRuleTemplate> createAndSaveFirmwareRuleTemplates(String idPattern, int number) throws ValidationException {
    ...
    private List<FirmwareRuleTemplate> createAndSaveFirmwareTemplates(String idPart, ApplicableAction.Type type, Integer numberOfTemplatesToCreate) throws ValidationException {
        List<FirmwareRuleTemplate> result = new ArrayList<>();
    ...
    private List<FirmwareRuleTemplate> createAndSaveFirmwareTemplatesOfRuleTemplateType(Integer numberOfTemplatesToCreate) throws ValidationException {
        return createAndSaveFirmwareTemplates("ruleType", ApplicableAction.Type.RULE_TEMPLATE, numberOfTemplatesToCreate);
    }

    private List<FirmwareRuleTemplate> createAndSaveFirmwareTemplatesOfDefinePropertiesTemplateType(Integer numberOfTemplatesToCreate) throws ValidationException {
    ...
    private List<FirmwareRuleTemplate> createAndSaveFirmwareTemplatesOfBlockingFilterTemplateTypeType(Integer numberOfTemplatesToCreate) throws ValidationException {
    ...
    private FirmwareRuleTemplate createAndSaveFirmwareRuleTemplate(String id, Integer priority) throws ValidationException {
    ...
    private FirmwareRuleTemplate createFirmwareRuleTemplate(String id, Integer priority) throws ValidationException {
        FirmwareRuleTemplate result = createFirmwareRuleTemplate();
        result.setId(id);
