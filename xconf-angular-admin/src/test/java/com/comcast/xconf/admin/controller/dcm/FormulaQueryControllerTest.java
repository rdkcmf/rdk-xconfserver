...
public class FormulaQueryControllerTest extends BaseControllerTest {
    ...
    public void getFormula() throws Exception {
        ...
        mockMvc.perform(get("/dcm/formula/" + formula.getId()))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(formula)));
    }
    ...
    public void getPage() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula/filtered")
                .param("pageSize", "10").param("pageNumber", "1"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(formula))));
    }

    @Test
    public void create() throws Exception {
        DCMGenericRule formula = createFormula();
        mockMvc.perform(post("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formula)))
    ...
    public void createWithoutId() throws Exception {
        ...
        String strResponse = mockMvc.perform(post("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formula)))
    ...
    public void createFormulaNormalizeCondition() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                                 .content(CoreUtil.toJSON(formula))).andReturn().getResponse().getContentAsString();
    ...
    public void creatingReturnsValidationException() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formula)))
    ...
    public void updateFormula() throws Exception {
        ...
        mockMvc.perform(put("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formula)))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(formula)));
    }
    ...
    public void updateFormulaNormalizeCondition() throws Exception {
        ...
        mockMvc.perform(put("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                                .content(CoreUtil.toJSON(formulaToUpdate)));
    ...
    public void updatingReturnsValidationException() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(put("/dcm/formula").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formulaToUpdate)))
                .andExpect(status().isBadRequest());
    ...
    public void changePriorities() throws Exception {
        DCMGenericRule formula = createFormula();
        dcmRuleDAO.setOne(formula.getId(), formula);
        mockMvc.perform(post("/dcm/formula/" + formula.getId() + "/priority/" + 3)
    ...
    public void verifyPrioritiesNotChangedForXHome() throws Exception {
        ...
        DCMGenericRule formula = CoreUtil.clone(stbFormulas.get(0));
        formula.setPriority(5);
        mockMvc.perform(post("/dcm/formula/" + formula.getId() + "/priority/" + listSize)
                .cookie(stbCookie))
                .andExpect(status().isOk());
        ...
        performPutRequestAndVerify("dcm/formula", formula);
        assertXhomeFormulasAreTheSame(xhomeFormulas);

        performDeleteRequestAndVerify("dcm/formula/" + formula.getId());
        assertXhomeFormulasAreTheSame(xhomeFormulas);
    }
    ...
    public void getSettingsAvailability() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula/settingsAvailability")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(Lists.newArrayList(formula.getId()))))
                .andExpect(status().isOk()).andExpect(content().json(CoreUtil.toJSON(settingsAvailability)));
    }
    ...
    public void deleteFormula() throws Exception {
        DCMGenericRule formula = createFormula();
        dcmRuleDAO.setOne(formula.getId(), formula);
        mockMvc.perform(delete("/dcm/formula/" + formula.getId()))
    ...
    public void getFormulasSize() throws Exception {
        DCMGenericRule formula = createFormula();
        dcmRuleDAO.setOne(formula.getId(), formula);
        mockMvc.perform(get("/dcm/formula/size"))
                .andExpect(status().isOk())
    ...
    public void getFormulasNames() throws Exception {
        DCMGenericRule formula = createFormula();
        dcmRuleDAO.setOne(formula.getId(), formula);
        mockMvc.perform(get("/dcm/formula/names"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(formula.getName()))));
    }
    ...
    public void importAlreadyExistingFormulasWithOverwriteFalse() throws Exception {
        ...
        String actualResult = mockMvc.perform(post("/dcm/formula/import").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(wrappedFormulas)))
        ...
        JSONAssert.assertEquals(CoreUtil.toJSON(expectedResult), actualResult, true);
    }
    ...
    public void importManyFormulasCheckThatPriorityWasSavedCorrectly() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula/import").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(wrappedFormulasWithSettings)))
                .andExpect(status().isOk());
        List<DCMGenericRule> actualResult = dcmRuleDAO.getAll();

        JSONAssert.assertEquals(CoreUtil.toJSON(expectedResult), CoreUtil.toJSON(actualResult), false);
    }
    ...
    public void importFormulaNormalizeConditions() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula/import/false").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formulaWithSettings)))
                .andExpect(status().isOk());
    ...
    public void importingFormulaReturnsValidationException() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/dcm/formula/import/false").contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(formulaWithSettings)))
                .andExpect(status().isBadRequest());
    ...
    public void getFormulasAvailability() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula/formulasAvailability")
                .contentType(MediaType.APPLICATION_JSON)
                .content(CoreUtil.toJSON(Lists.newArrayList(vodSettingsId, vodSettingsId + 1))))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(new HashMap() {{
    ...
    public void searchFormulaByFreeAndFixedArg() throws Exception {
        ...
        mockMvc.perform(post("/dcm/formula/filtered")
                ...
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(dcmGenericRule))));
        ...
        mockMvc.perform(post("/dcm/formula/filtered")
                ...
                .param("pageSize", "1")
                .param("pageNumber", "1")
                .content(CoreUtil.toJSON(new HashMap<SearchFields, String>())))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Lists.newArrayList(dcmGenericRule))));
    }
    ...
    public void exportOne() throws Exception {
        ...
        performExportRequestAndVerifyResponse("/dcm/formula/" + dcmRule.getId(), entity, ApplicationType.STB);
    }
    ...
    public void exportAll() throws Exception {
        ...
        performExportRequestAndVerifyResponse("/dcm/formula", resultList, ApplicationType.STB);
    }
    ...
    private void assertXhomeFormulasAreTheSame(List<DCMGenericRule> xhomeFormulas) throws Exception {
        mockMvc.perform(post("/dcm/formula/filtered")
                ...
                .param("pageNumber", "1"))
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(xhomeFormulas)));
    }

    private List<DCMGenericRule> createFormulasList(int listSize, String applicationType) throws ValidationException {
    ...
    private DCMGenericRule createAndSaveFormula(String id, Integer priority, Relation relation) throws ValidationException {
        DCMGenericRule result = createFormula(id, priority, relation);
        dcmRuleDAO.setOne(result.getId(), result);
        return result;
    }

    private DCMGenericRule createAndSaveFormula(String id, Integer priority, String applicationType) throws ValidationException {
    ...
    private DCMGenericRule createFormula(String id, Integer priority) throws ValidationException {
        return createFormula(id, priority, null);
    }

    private DCMGenericRule createFormula(String id, Integer priority, Relation relation) throws ValidationException {
