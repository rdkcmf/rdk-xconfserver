...
<head>
    ...
    <c:choose>
        <c:when test="${profile eq 'dev'}">
            ...
            <script src="<c:url value="/app/shared/directives/progress-button.directive.js"/>"></script>
            ...
            <script src="<c:url value="/app/shared/directives/editable-list/editable-list.directive.js"/>"></script>
                    ...
                    <div class="navbar-right">
                        ...
                        <ul class="nav navbar-nav nav-logout">
                            <div class="pull-right logout-container">
                                ...
                                <a class="glyphicon glyphicon-log-out logout" href='../ux'></a>
                            </div>
