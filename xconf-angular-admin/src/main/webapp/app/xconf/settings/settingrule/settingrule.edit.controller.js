...
(function() {
    ...
    controller.$inject=['$rootScope', '$scope', '$state', '$stateParams', '$controller', 'alertsService', 'ruleHelperService', 'settingRuleService', 'settingProfileService', 'ruleValidationService', 'TARGETING_RULE_OPERATION_ARRAY', 'LOG_UPLOAD_FREE_ARG_AUTOCOMPLETE_VALUE', 'FREE_ARG_NAME'];

    function controller($rootScope, $scope, $state, $stateParams, $controller, alertsService, ruleHelperService, settingRuleService, settingProfileService, ruleValidationService, TARGETING_RULE_OPERATION_ARRAY, LOG_UPLOAD_FREE_ARG_AUTOCOMPLETE_VALUE, FREE_ARG_NAME) {
        var vm = this;
