            ...
            function($log, $window, $location, $rootScope, $state, $dialogs, $cookies, $localStorage, utilsService, alertsService, authUtilsService, PERMISSION, authService, dialogsService, AUTH_EVENT, APPLICATION_TYPES) {
                ...
                $rootScope.$on('$stateChangeStart', function(event, next) {
                    if (angular.isDefined(next.data)) {
                        ...
                        /* Cookies can be configured to store jwtTokens to authenticate user
                        * if (!$cookies.get('token')  && !isDevProfile) {
                            event.preventDefault();
                            $rootScope.$broadcast(AUTH_EVENT.UNAUTHORIZED);
                        } else */
                        if (!authUtilsService.hasOneOfPermissions(permissions)) {
                            event.preventDefault();
    ...
    function state($stateProvider, $urlRouterProvider, PERMISSION) {
        ...
        $stateProvider
            .state('firmwareconfigs', {
                ...
                data: {
                    permissions: [PERMISSION.READ_FIRMWARE_STB, PERMISSION.READ_FIRMWARE_XHOME, PERMISSION.READ_FIRMWARE_ALL]
                }
            })
            .state('firmwareconfig-edit', {
                ...
                data: {
                    permissions: [PERMISSION.WRITE_FIRMWARE_ALL, PERMISSION.WRITE_FIRMWARE_XHOME, PERMISSION.WRITE_FIRMWARE_STB]
                }
            })
            ...
            .state('permanentprofiles', {
                ...
                data: {
                    permissions: [PERMISSION.READ_TELEMETRY_ALL, PERMISSION.READ_TELEMETRY_STB, PERMISSION.READ_TELEMETRY_XHOME]
                }
            })
            .state('permanentprofile-edit', {
                ...
                data: {
                    permissions: [PERMISSION.WRITE_TELEMETRY_ALL, PERMISSION.WRITE_TELEMETRY_STB, PERMISSION.WRITE_TELEMETRY_XHOME]
                }
            })
            ...
            .state('settings-testpage', {
                ...
                templateUrl: 'app/shared/pages/testpage/testpage.html',
                data: {
                    permissions: [PERMISSION.READ_DCM_ALL, PERMISSION.READ_DCM_STB, PERMISSION.READ_DCM_XHOME],
                    pageType: 'SETTINGS',
            ...
            .state('feature-edit', {
                ...
                data: {
                    permissions: [PERMISSION.WRITE_DCM_ALL, PERMISSION.WRITE_DCM_STB, PERMISSION.WRITE_DCM_XHOME]
                }
            })
            ...
            .state('firmwarerules', {
                ...
                data: {
                    permissions: [PERMISSION.READ_FIRMWARE_ALL, PERMISSION.READ_FIRMWARE_STB, PERMISSION.READ_FIRMWARE_XHOME]
                }
            })
            .state('firmwarerule-add', {
                ...
                data: {
                    permissions: [PERMISSION.WRITE_FIRMWARE_ALL, PERMISSION.WRITE_FIRMWARE_STB, PERMISSION.WRITE_FIRMWARE_XHOME]
                }
            })
