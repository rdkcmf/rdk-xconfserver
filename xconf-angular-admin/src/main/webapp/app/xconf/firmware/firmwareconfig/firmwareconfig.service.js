...
(function() {
    ...
    function service(utilsService, $http, syncHttpService) {
        ...
        return {
            ...
            verifyIfVersionsExistByListAndEnvModelRuleName: verifyIfVersionsExistByListAndEnvModelRuleName,
        ...
        function verifyIfVersionsExistByListAndEnvModelRuleName(envModelRuleName, firmwareVersions) {
            return $http.post(URL + '/verifyIfFirmwareVersionsExistByList?modelId=' + envModelRuleName, firmwareVersions);
        }

        function exportById(id) {
            window.open('firmwareconfig/' + id + '?export');
        }

        function exportAll() {
            window.open('firmwareconfig?exportAll');
        }
