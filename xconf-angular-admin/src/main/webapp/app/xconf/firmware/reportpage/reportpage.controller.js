...
(function() {
    ...
    controller.$inject = ['$scope', 'firmwareReportPageService', 'alertsService', 'FileSaver', 'Blob', 'utilsService'];

    function controller($scope, firmwareReportPageService, alertsService, FileSaver, Blob, utilsService) {
        var vm = this;
        ...
        function getMacRules() {
            firmwareReportPageService.getMacRulesNames().then(
                function(result) {
