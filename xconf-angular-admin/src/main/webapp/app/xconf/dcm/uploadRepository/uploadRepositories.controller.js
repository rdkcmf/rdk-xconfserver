...
(function() {
    ...
    function controller($scope, $controller, uploadRepositoryService, alertsService, dialogs, utilsService, uploadRepositoriesSize, paginationService, EDIT_MODE) {
        ...
        vm.exportAllUploadRepositories = exportAllUploadRepositories;
        vm.exportUploadRepository = exportUploadRepository;
        ...
        function exportUploadRepository(id) {
            window.open('dcm/uploadRepository/' + id + '/?export');
        }

        function exportAllUploadRepositories() {
            window.open('dcm/uploadRepository/?export');
        }
