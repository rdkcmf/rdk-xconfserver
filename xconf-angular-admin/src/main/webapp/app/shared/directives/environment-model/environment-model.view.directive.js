            ...
            link: function (scope, element, attrs) {
                ...
                function init() {
                    if (scope.entityType === ENTITY_TYPE.MODEL) {
                        ...
                        scope.entityExportLink = 'environment';
                ...
                scope.exportOne = function(entityId) {
                    window.open(scope.entityExportLink + '/' + entityId + '?export');
                };

                scope.exportAll = function() {
                    window.open(scope.entityExportLink + '?export');
                };
