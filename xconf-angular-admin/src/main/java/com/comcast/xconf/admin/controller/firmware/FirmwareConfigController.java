...
public class FirmwareConfigController extends AbstractController<FirmwareConfig> {
    public static final String URL_MAPPING = "firmwareconfig";
    ...
    public ResponseEntity getFirmwareConfingBySupportedModels(@RequestBody Set<String> modelIds) {
        return new ResponseEntity<>(firmwareConfigService.getFirmwareConfigBySupportedModels(modelIds), HttpStatus.OK);
    }
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/verifyIfFirmwareVersionsExistByList")
    public ResponseEntity verifyIfFirmwareConfigExistsByVersion(@RequestParam String modelId, @RequestBody Set<String> firmwareVersionsToVerify) {
        return new ResponseEntity<>(firmwareConfigService.verifyIfFirmwareVersionsExistsByList(modelId, firmwareVersionsToVerify), HttpStatus.OK);
    }
