 ...
 */
@RestController
@RequestMapping(value = "/dcm/formula")
public class FormulaQueryController extends AbstractController<DCMGenericRule> {
    ...
    public ResponseEntity importFormula(@RequestBody DCMRuleWithSettings formulaWithSettings, @PathVariable final Boolean overwrite) throws ValidationException {
        return new ResponseEntity<>(formulaService.importFormula(formulaWithSettings, overwrite), HttpStatus.OK);
    }

    @RequestMapping(value = "/import", method = RequestMethod.POST)
    public ResponseEntity importFormulas(@RequestBody List<OverwriteWrapper<DCMRuleWithSettings>> wrappedFormulasWithSettings) throws ValidationException {
