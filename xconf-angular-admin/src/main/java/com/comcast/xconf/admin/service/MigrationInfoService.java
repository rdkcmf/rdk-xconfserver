...
public class MigrationInfoService {
    ...
    private static Map<Class, ISimpleCachedDAO> oldEntitiesDao = new HashMap<>();
    private static Map<Class, ISimpleCachedDAO> newEntitiesDao = new HashMap<>();
            ...
            for (Class<?> annotatedClass : annotatedClasses) {
                for (Method method : annotatedClass.getDeclaredMethods()) {
                    ...
                    if (annotation != null) {
                        ...
                        oldEntitiesDao.put(annotation.oldEntity(), DaoFactory.Simple.createCachedDAO(annotation.oldKey(), annotation.oldEntity()));
                        newEntitiesDao.put(annotation.newEntity(), DaoFactory.Simple.createCachedDAO(annotation.newKey(), annotation.newEntity()));
                    }
                }
            }
        }
