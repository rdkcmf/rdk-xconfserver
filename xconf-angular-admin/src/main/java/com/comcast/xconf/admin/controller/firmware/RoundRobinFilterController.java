...
@RestController
@RequestMapping(RoundRobinFilterController.url)
public class RoundRobinFilterController {
    public static final String url = "/roundrobinfilter";
    ...
    public ResponseEntity updateDownloadLocationRoundRobinFilter(@RequestBody DownloadLocationRoundRobinFilterValue filter) throws ValidationException {
        roundRobinFilterService.save(filter);
        LoggingUtils.log(logger, Level.INFO, "Successfully updated {} with info: {}", filter.getClass().getSimpleName(), CoreUtil.toJSON(filter));
