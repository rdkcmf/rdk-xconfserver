...
public class GenericNamespacedListController extends AbstractController<GenericNamespacedList> {
    ...
    public static final String URL_MAPPING = "genericnamespacedlist";
    ...
    public ResponseEntity updateNamespacedList(
            ...
            @PathVariable String newId) throws ValidationException{
    ...
    private void log(String strMethod, GenericNamespacedList entity) {
