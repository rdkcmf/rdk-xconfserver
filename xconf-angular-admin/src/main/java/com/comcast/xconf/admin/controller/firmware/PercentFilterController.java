...
@RestController
@RequestMapping(value = PercentFilterController.URL_MAPPING)
public class PercentFilterController {

    public static final String URL_MAPPING = "/percentfilter";
    ...
    public ResponseEntity savePercentFilter(@RequestBody GlobalPercentage globalPercentage) throws ValidationException {

        globalPercentageService.updateGlobalPercentage(globalPercentage);
        LoggingUtils.log(logger, Level.INFO, "Successfully updated {} with info: {}", globalPercentage.getClass().getSimpleName(), CoreUtil.toJSON(globalPercentage));
