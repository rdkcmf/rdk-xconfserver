...
@RestController
@RequestMapping(value = "/firmwareruletemplate", produces = MediaType.APPLICATION_JSON_VALUE)
public class FirmwareRuleTemplateController extends AbstractController<FirmwareRuleTemplate> {
    ...
    public ResponseEntity importTemplates(@RequestBody List<OverwriteWrapper<FirmwareRuleTemplate>> wrappedFirmwareRuleTemplates) throws ValidationException {
