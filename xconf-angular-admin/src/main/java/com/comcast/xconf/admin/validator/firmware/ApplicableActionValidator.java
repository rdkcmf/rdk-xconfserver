    ...
    private void validateRuleAction(FirmwareRule firmwareRule, RuleAction action) {
        ...
        if (configEntries != null) {
            ...
            for (RuleAction.ConfigEntry entry : configEntries) {
                ...
                if (percentage == null) {
                    throw new ValidationRuntimeException("Percentage is not define for distribution config");
                }
                if (percentage < 0 || percentage > 100 ) {
                    throw new ValidationRuntimeException("Percentage could not be negative or 0 or bigger that 100");
                }
