...
public interface RoundRobinFilterService {

    SingletonFilterValue getOne(String id);

    SingletonFilterValue save(SingletonFilterValue singletonFilterValue) throws ValidationException;

    List<DownloadLocationRoundRobinFilterValue> getAllRoundRobinFilters();
}
