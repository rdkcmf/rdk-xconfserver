...
import com.comcast.xconf.admin.service.common.EnvironmentService;
...
@RestController
@RequestMapping(EnvironmentController.URL_MAPPING)
public class EnvironmentController extends AbstractController<Environment> {
    public final static String URL_MAPPING = "environment";
    ...
    public String getOneEntityExportName() {
        return ExportFileNames.ENVIRONMENT.getName();
    }

    @Override
    public String getAllEntitiesExportName() {
        return ExportFileNames.ALL_ENVIRONMENTS.getName();
    }

    @Override
    public AbstractService<Environment> getService() {
