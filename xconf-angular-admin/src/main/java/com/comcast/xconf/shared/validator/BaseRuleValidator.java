 ...
 */
package com.comcast.xconf.shared.validator;
...
public class BaseRuleValidator<T extends XRule> implements IValidator<T> {
    ...
    public void runGlobalValidation(final Rule rule) {
        ...
        final Collection<Condition> conditions = Lists.newArrayList(RuleHelper.toConditions(rule));
    ...
    private void checkDuplicateConditions(Rule rule) {
        Collection<Condition> duplicateConditions = RuleUtil.getDuplicateConditions(rule);
