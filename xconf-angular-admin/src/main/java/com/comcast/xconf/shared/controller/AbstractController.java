...
public abstract class AbstractController<T extends IPersistable & Comparable> {
    ...
    public ResponseEntity create(@RequestBody T entity) throws ValidationException {
    ...
    public ResponseEntity update(@RequestBody T entity) throws ValidationException {
    ...
    private void log(String strMethod, T entity) {
        LoggingUtils.log(logger, Level.INFO, "Successfully " + strMethod + " {} with info: {}", entity.getClass().getSimpleName(), CoreUtil.toJSON(entity));
    }
