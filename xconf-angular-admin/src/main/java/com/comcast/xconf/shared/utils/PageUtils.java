...
public class PageUtils {
    ...
    public static <K, T extends IPersistable & Comparable> Map<K, T> getPageAsMap(final ISimpleCachedDAO<K, T> dao, final int page, final int pageSize) {
    ...
    public static <K, T extends IPersistable & Comparable> List<T> getPageAsList(final ISimpleCachedDAO<K, T> dao, final int page, final int pageSize) {
    ...
    public static <T extends IPersistable & Comparable> List<T> getPage(final List<T> list, final int page, final int pageSize, PriorityComparator comparator) {
