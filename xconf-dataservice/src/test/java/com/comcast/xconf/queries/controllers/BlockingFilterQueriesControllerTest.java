...
public class BlockingFilterQueriesControllerTest extends BaseQueriesControllerTest {
    ...
    public void testUpdateIpFilter() throws Exception {
        ...
        mockMvc.perform(
                post("/" + QueryConstants.UPDATE_FILTERS_IPS)
                        ...
                        .content(CoreUtil.toJSON(changedIpFilter)))
    ...
    public void testRemoveIpFilter() throws Exception {
        ...
        mockMvc.perform(
                delete("/" + QueryConstants.DELETE_FILTERS_IPS + "/" + ipFilter.getName())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(CoreUtil.toJSON(ipFilter)))
    ...
    public void createPercentFilterWithWrongApplicationType() throws Exception {
        ...
        mockMvc.perform(post("/" + QueryConstants.UPDATE_FILTERS_PERCENT)
                ...
                .content(CoreUtil.toJSON(new PercentFilterWrapper(percentFilter))))
    ...
    public void getPercentFilterParameter() throws Exception {
        ...
        mockMvc.perform(get("/" + QueryConstants.QUERIES_FILTERS_PERCENT)
                ...
                .andExpect(status().isOk())
                .andExpect(content().json(CoreUtil.toJSON(Collections.singletonMap(fieldName, lastKnowGoodVersions))));
    }
    ...
    public void testUpdateTimeFilter() throws Exception {
        ...
        mockMvc.perform(
                post("/" + QueryConstants.UPDATE_FILTERS_TIME)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .content(CoreUtil.toJSON(timeFilter)))
                .andExpect(status().isOk());
    ...
    TimeFilter createTimeFilter() throws ValidationException {
    ...
    Map<String, TimeFilter> createTimeFilters(String stbName, String xhomeName) throws ValidationException {
    ...
    IpFilter createIpFilter() throws ValidationException {
    ...
    private PercentFilterValue createPercentFilter() throws ValidationException {
    ...
    private Map<String, EnvModelPercentage> createEnvModelPercentages() throws ValidationException {
    ...
    private EnvModelPercentage createEnvModelPercentage() throws ValidationException {
    ...
    private EnvModelPercentage createEnvModelPercentage(FirmwareConfig firmwareConfig) throws ValidationException {
        EnvModelPercentage envModelPercentage = createEnvModelPercentage();
    ...
    private EnvModelRuleBean createEnvModelRuleBean() throws ValidationException {
        EnvModelRuleBean envModelRuleBean = createDefaultEnvModelRuleBean();
    ...
    private PercentFilterValue createPercentFilter(String applicationType, Integer globalPercentage, FirmwareConfig firmwareConfig) throws ValidationException {
    ...
    private PercentFilterValue createAndSavePercentFilter(String applicationType, Integer globalPercentage, FirmwareConfig firmwareConfig) throws ValidationException {
