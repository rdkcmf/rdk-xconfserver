...
public class TelemetryProfileControllerTest extends BaseQueriesControllerTest {
    ...
    private Map<String, TelemetryRule> createAndSaveTelemetryRules(String stbName, String xhomeName, Map<String, PermanentTelemetryProfile> profiles) throws ValidationException {
