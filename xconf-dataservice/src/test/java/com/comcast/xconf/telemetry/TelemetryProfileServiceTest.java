...
public class TelemetryProfileServiceTest extends BaseQueriesControllerTest {
    ...
    @Test
    public void createTelemetryProfileTest() throws ValidationException {
    ...
    @Test
    public void dropTelemetryForTest() throws ValidationException {
        TelemetryProfile telemetryProfile = new TelemetryProfile();
        telemetryProfile.setId(ID);
        TimestampedRule timestampedRule = telemetryProfileService.createTelemetryProfile(ATTRIBUTE, VALUE, telemetryProfile);
    ...
    @Test
    public void getTemporaryProfileForContextExpiredTest() throws ValidationException, InterruptedException {
        TelemetryProfile telemetryProfile = new TelemetryProfile();
        telemetryProfile.setId(ID);
    ...
    @Test
    public void getTemporaryProfileForContextNotExpiredTest() throws ValidationException {
        TelemetryProfile telemetryProfile = new TelemetryProfile();
        telemetryProfile.setId(ID);
        telemetryProfile.setExpires(DateTime.now(DateTimeZone.UTC).getMillis());
        TimestampedRule timestampedRule = telemetryProfileService.createTelemetryProfile(ATTRIBUTE, VALUE, telemetryProfile);
    ...
    @Test
    public void getTemporaryProfileForContextInvalidContextTest() throws ValidationException {
        Map<String, String> context = new HashMap<>();
        context.put(ATTRIBUTE, VALUE);
    ...
    @Test
    public void getPermanentProfileForContextOneRuleTest() throws ValidationException {
    ...
    @Test
    public void getPermanentProfileForContextReturnIsRuleWithHigherPriorityAmongIsAndLikeRulesTest() throws ValidationException {
    ...
    @Test
    public void getPermanentProfileForContextReturnLikeRuleWithHigherPriorityAmongPercentAndLikeRulesTest() throws ValidationException {
        TelemetryRule rule1 = new TelemetryRule();
        rule1.setId("id1");
        rule1.setName("name1");
        rule1.setBoundTelemetryId("myBoundTelemetryId1");
    ...
    @Test
    public void getPermanentProfileForContextReturnCompoundRuleAmongSimpleAndCompoundRulesTest() throws ValidationException {
        TelemetryRule rule1 = new TelemetryRule();
        rule1.setId("id1");
        rule1.setName("name1");
        rule1.setBoundTelemetryId("myBoundTelemetryId1");
    ...
    @Test
    public void getAvailableDescriptorsTest() throws ValidationException {
        TelemetryRule rule = new TelemetryRule();
        rule.setId("id");
        rule.setName("name");
    ...
    @Test
    public void getAvailableProfileDescriptorsTest() throws ValidationException {
        TelemetryRule rule = new TelemetryRule();
        rule.setId("id");
        rule.setName("name");
        rule.setBoundTelemetryId("myBoundTelemetryId");
    ...
    @Test
    public void createRuleForAttributeTest() throws ValidationException, InterruptedException {
    ...
    public void testLatestTelemetryOnly() {
        ...
        }catch (ValidationException ve){} // do nothing
