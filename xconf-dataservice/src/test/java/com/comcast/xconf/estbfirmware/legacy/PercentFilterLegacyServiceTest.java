...
public class PercentFilterLegacyServiceTest {
    ...
    public void testSave() throws Exception {
        ...
        ISimpleCachedDAO<String, SingletonFilterValue> filterDaoMock = mock(ISimpleCachedDAO.class);
    ...
    public void testGet() throws Exception {
        ...
        ISimpleCachedDAO<String, SingletonFilterValue> singletonFilterDaoMock = mock(ISimpleCachedDAO.class);
        ...
        ISimpleCachedDAO<String, FirmwareRule> firmwareRuleDaoMock = createFirmwareDaoMock();
    ...
    @Test
    public void renameNamespacedListInAllWhitelist() throws ValidationException {
        PercentFilterLegacyService service = new PercentFilterLegacyService();
        PercentFilterValue filter = createFilter();
    ...
    @Test
    public void renameEnvModeRule() throws ValidationException {
        PercentFilterLegacyService service = new PercentFilterLegacyService();
        PercentFilterValue filter = createFilter();
    ...
    private ISimpleCachedDAO<String, FirmwareRule> createFirmwareDaoMock() {
        ISimpleCachedDAO<String, FirmwareRule> firmwareRuleDaoMock = mock(ISimpleCachedDAO.class);
