...
public class PercentFilterTest {
    ...
    private void createAndSavePercentFilterWithLKG() throws ValidationException {
        PercentFilterValue filterValue = new PercentFilterValue();
        filterValue.setPercentage(0.0);
        EnvModelPercentage envModelPercentage = getEnvModelPercentage();
    ...
    private void createAndSavePercentFilter() throws ValidationException {
        PercentFilterValue filterValue = new PercentFilterValue();
        filterValue.setPercentage(0.0);
        EnvModelPercentage envModelPercentage = getEnvModelPercentage();
        envModelPercentage.setFirmwareCheckRequired(true);
    ...
    private FirmwareConfig createAndSaveFirmwareConfig(String configId, String version) throws ValidationException {
