...
/**
 * The concurrent hash map implementation built by {@link com.google.common.cache.CacheBuilder}.
 *
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  // Constants
    ...
    static{
        LoggerFactory.getLogger(LocalCache.class).error("guavaLocalCache is fixed in xconf-ds.");
    }
  /**
  ...
  boolean usesKeyReferences() {
    return !Strength.STRONG.name().equals(keyStrength.name());
  }

  boolean usesValueReferences() {
    return !Strength.STRONG.name().equals(valueStrength.name());
  }
  ...
  interface ValueReference<K, V> {
     ...
     *
     * @throws java.util.concurrent.ExecutionException if the loading thread throws an exception
     * @throws com.google.common.util.concurrent.ExecutionError if the loading thread throws an error
     */
  ...
  /**
   * Returns the result of calling {@link com.google.common.cache.CacheLoader#loadAll}, or null if {@code loader} doesn't
