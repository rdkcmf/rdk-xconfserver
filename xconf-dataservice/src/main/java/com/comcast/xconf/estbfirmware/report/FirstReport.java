...
public class FirstReport {
	...
	public void doReport(Set<String> macAddresses, OutputStream out) {
		...
		for (String ma : macAddresses) {
			...
			LastConfigLog ll = lastConfigLogDAO.getOne(ma, LastConfigLog.LAST_CONFIG_LOG_ID);
			...
			if (ll != null) {
				...
				List<ConfigChangeLog> chs = configChangeLogDAO.getAll(ma, ConfigChangeLog.FILTER_LAST_CONFIG);
