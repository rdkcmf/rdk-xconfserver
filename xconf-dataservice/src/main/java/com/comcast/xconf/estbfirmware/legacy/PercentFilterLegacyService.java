...
public class PercentFilterLegacyService {
    ...
    public void save(PercentFilterValue filter) throws ValidationException {
    ...
    public void renameNamespacedListInAllWhitelist(String oldNamespacedListId, String newNamespacedListId) throws ValidationException {
        PercentFilterValue percentFilter = get();
    ...
    public void renameEnvModelRule(String oldRuleName, String newRuleName) throws ValidationException {
        PercentFilterValue percentFilter = get();
