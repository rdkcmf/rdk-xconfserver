...
import com.comcast.hesperius.dataaccess.core.dao.IListingDAO;
...
public class EstbFirmwareService {
    ...
    @Autowired
    protected IListingDAO<String, String, LastConfigLog> lastConfigLogDAO;

    @Autowired
    protected IListingDAO<String, String, ConfigChangeLog> configChangeLogDAO;
    ...
    protected ResponseEntity getLastLog(String macAddress) {
        ...
        LastConfigLog lastConfigLog = lastConfigLogDAO.getOne(mac, LastConfigLog.LAST_CONFIG_LOG_ID);
    ...
    protected ResponseEntity getChangeLogs(String macAddress) {
        ...
        List<ConfigChangeLog> logs = configChangeLogDAO.getAll(mac, ConfigChangeLog.FILTER_LAST_CONFIG);
        if (!logs.isEmpty()) {
            ...
            CoreUtil.doAsync(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        lastConfigLogDAO.setOne(rowKey, lastConfigLog);
                        ...
                        if (evaluationResult.getMatchedRule() != null && !evaluationResult.isBlocked()
                            ...
                            configChangeLogDAO.setOne(context.geteStbMac(), configChangeLog);
                        }
