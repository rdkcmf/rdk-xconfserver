...
public class PercentFilterService {
    ...
    public void save(PercentFilterValue filter, String applicationType) throws ValidationException {
    ...
    private Iterable<FirmwareRule> getEnvModelFirmwareRules(String applicationType) {
        ...
        return Iterables.filter(Optional.presentInstances(firmwareRuleDao.asLoadingCache().asMap().values()), Predicates.and(predicates));
    }
