...
public class LogFileQueriesController {
    ...
    @Autowired
    private ISimpleCachedDAO<String, LogFilesGroup> logFilesGroupDAO;
    ...
    private void updateLogUploadSettingsAndLogFileGroups(LogFile logFile) throws ValidationException {
