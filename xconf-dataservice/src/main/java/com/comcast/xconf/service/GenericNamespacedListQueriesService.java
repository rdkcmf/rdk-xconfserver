...
public interface GenericNamespacedListQueriesService {
    ...
    GenericNamespacedList createNamespacedList(final GenericNamespacedList list, final String type) throws ValidationException;

    GenericNamespacedList updateNamespacedList(final GenericNamespacedList list, final String type) throws ValidationException;

    GenericNamespacedList updateNamespacedList(final GenericNamespacedList list, final String type, final String newId) throws ValidationException;
    ...
    GenericNamespacedList addNamespacedListData(String listId, String listType, StringListWrapper macList) throws ValidationException;

    GenericNamespacedList removeNamespacedListData(final String listId, String listType, final StringListWrapper wrappedMacList) throws ValidationException;
