...
public class ConversionServiceImpl extends GenericConversionService {
    ...
    public void init() throws BeansException {
        ...
        addConverter(new StringToIpAddressGroup());
    ...
    private static class StringToIpAddressGroup implements
            Converter<String, IpAddressGroup> {
        @Override
        public IpAddressGroup convert(String id) {
            if (StringUtils.isBlank(id)) {
                return null;
            }
            ...
            if(id.contains("id=")){
                realId = StringUtils.substringBetween(id,"id=",", name"); //TODO: fix it
            }

            return (IpAddressGroup)DaoFactory.Simple.createCachedDAO(String.class, IpAddressGroupExtended.class).getOne(realId);
        }
    }
