...
public class MigrationController {
    ...
    @Autowired
    private ISimpleCachedDAO<String, com.comcast.xconf.estbfirmware.FirmwareRule> firmwareRuleDAO; // old dao

    @Autowired
    private ISimpleCachedDAO<String, FirmwareRule> firmwareRuleDao; // new dao
    ...
    private void filterOutExistingTemplates(List<FirmwareRuleTemplate> templates) {
        ...
        Iterable<FirmwareRuleTemplate> all = DaoFactory.Simple.createDAO(String.class, FirmwareRuleTemplate.class).getAll();
    ...
    private <T extends IPersistable> String createAll(ISimpleCachedDAO<String, T> dao, List<T> list) {
    ...
    private <T extends IPersistable> boolean save(ISimpleCachedDAO<String, T> dao, T entity) {
        try {
