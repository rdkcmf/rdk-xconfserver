...
public class FeatureControlSettingsController {
    ...
    public ResponseEntity getDefaultFeatureSettings(HttpServletRequest request, @RequestParam Map<String, String> context) {
        return getFeatureSettings(request, context, STB);
    }
    ...
    public ResponseEntity getFeatureSettingsByApplication(HttpServletRequest request,
        ...
        return getFeatureSettings(request, context, applicationType);
    }

    private ResponseEntity getFeatureSettings(HttpServletRequest request, Map<String, String> context, String applicationType) {
        ResponseEntity response = svc.getFeatureSettings(request, context,applicationType);
        return response;
    }
