...
public class IpAddressGroupEvaluator extends BaseEvaluator {
    ...
    private static final ISimpleCachedDAO<String, GenericNamespacedList> nsListDao = DaoFactory.Simple.createCachedDAO(String.class, GenericNamespacedList.class);
