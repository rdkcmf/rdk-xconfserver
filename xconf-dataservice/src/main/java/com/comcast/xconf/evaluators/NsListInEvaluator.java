...
public class NsListInEvaluator extends BaseEvaluator {
    ...
    private static final ISimpleCachedDAO<String, GenericNamespacedList> genericListDao = DaoFactory.Simple.createCachedDAO(String.class, GenericNamespacedList.class);
